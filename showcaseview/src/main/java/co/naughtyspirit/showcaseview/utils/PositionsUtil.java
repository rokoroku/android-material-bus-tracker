...
public class PositionsUtil {
    ...
    public static enum ItemPosition {
        ...
        CENTER_FULL, ADJUST_HEIGHT
    }

    public static RelativeLayout.LayoutParams configureParams(Context ctx, ItemPosition position) {
        RelativeLayout.LayoutParams layoutParams = configureParams(ctx, position, null);
        return layoutParams;
    }

    public static RelativeLayout.LayoutParams configureParams(Context ctx, ItemPosition position, Target target) {
        ...
        switch (position) {
            ...
            case BOTTOM_CENTER:
                params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
                params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                params.setMargins(80, 0, 80, 80 + 200);
                break;
            ...
            case ADJUST_HEIGHT:
                if (target != null && target.getLocation() != null) {
                    topMargin = (int) (target.getLocation()[1] - target.getLocation()[2]);
                }
