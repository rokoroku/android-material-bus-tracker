...
import kr.rokoroku.mbus.util.FontAwesome;
...
public class TextDrawable extends Drawable {
    ...
    public TextDrawable(Context context, FontAwesome.Icon icon, int colorId) {
        this(context, new FontAwesome().getTypeface(context), String.valueOf(icon.getCharacter()));
        setTextColor(context.getResources().getColor(colorId));
    }

    public TextDrawable(Context context, Typeface typeface, CharSequence text) {
        this(context);
