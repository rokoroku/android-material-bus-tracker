...
public class ArrivalInfo implements Parcelable {
    ...
    public ArrivalInfo(GbisStationRouteResult.ResultEntity.BusArrivalInfoEntity entity) {
    ...
    public ArrivalInfo(SeoulBusArrival entity) {
        ...
        this.isDriveEnd = "-2".equals(entity.getIsLast1()) || "-2".equals(entity.getIsLast2());
    }

    public ArrivalInfo(StationRouteResult.RouteEntity routeEntity) {
        this.routeId = routeEntity.busRouteId;
        this.stationId = routeEntity.stId;
        this.timestamp = System.currentTimeMillis();
