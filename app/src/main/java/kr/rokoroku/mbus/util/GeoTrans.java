...
public class GeoTrans {
    ...
    public static Point convert(int srctype, int dsttype, Point in_pt) {
        Point tmpPt = new Point();
        Point out_pt = new Point();
    ...
    public static void geo2tm(int dsttype, Point in_pt, Point out_pt) {
        double x, y;
    ...
    public static void tm2geo(int srctype, Point in_pt, Point out_pt) {
        Point tmpPt = new Point(in_pt.getX(), in_pt.getY());
        int max_iter = 6;
    ...
    public static double getDistancebyGeo(Point pt1, Point pt2) {
    ...
    public static double getDistancebyKatec(Point pt1, Point pt2) {
    ...
    public static double getDistancebyTm(Point pt1, Point pt2) {
	...
	*/
    ...
    private static void geocentric_to_wgs84(Point p) {
    ...
    private static void geocentric_from_wgs84(Point p) {
