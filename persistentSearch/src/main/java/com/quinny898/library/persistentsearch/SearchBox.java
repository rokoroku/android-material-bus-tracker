...
public class SearchBox extends RelativeLayout {
    ...
    public void setHint(String hint) {
        this.logoText = hint;
        this.logo.setText(hint);
        this.logo.setTextColor(Color.LTGRAY);
    }
    ...
    public void setMaxLength(int length) {
        this.search.setFilters(new InputFilter[]{new InputFilter.LengthFilter(
                length)});
    }
    ...
    public void setDrawerLogo(Drawable icon) {
        if (icon != null) {
            this.materialMenu.setVisibility(View.INVISIBLE);
        } else {
            this.materialMenu.setVisibility(View.VISIBLE);
        }
        this.drawerLogo.setImageDrawable(icon);
    }
